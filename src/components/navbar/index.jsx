          ...
          children={
            <div className="flex w-[360px] flex-col gap-3 rounded-[20px] bg-white p-4 shadow-xl shadow-shadow-500 dark:!bg-navy-700 dark:text-white dark:shadow-none sm:w-[460px]">
              ...
              <button className="flex w-full items-center">
                <div className="flex h-full w-[85px] items-center justify-center rounded-xl bg-gradient-to-b from-amber-400 to-orange-500 py-4 text-2xl text-white">
                  <MdOutlineInventory2 className="h-6 w-6" />
                </div>
                <div className="ml-2 flex h-full w-full flex-col justify-center rounded-lg px-1 text-sm">
                  <p className="mb-1 text-left text-base font-bold text-gray-900 dark:text-white">
                    🥦 3 pantry items expiring soon
                  </p>
                  <p className="font-base text-left text-xs text-gray-900 dark:text-white">
                    Check your pantry to use them before they expire!
                  </p>
                </div>
              </button>
              ...
              <button className="flex w-full items-center">
                ...
                <div className="ml-2 flex h-full w-full flex-col justify-center rounded-lg px-1 text-sm">
                  <p className="mb-1 text-left text-base font-bold text-gray-900 dark:text-white">
                    🍽️ Weekly meal plan is ready
                  </p>
                  <p className="font-base text-left text-xs text-gray-900 dark:text-white">
                    Your meal planner has been updated for this week.
                  </p>
                </div>
              </button>
            </div>
